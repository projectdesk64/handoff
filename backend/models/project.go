...
// - Money fields (TotalAmount, AdvanceReceived, TotalReceived, PartnerShareGiven) use REAL type
...
type Project struct {
	...
	TotalAmount        float64  `json:"totalAmount"` // REAL type - no calculations in backend
	AdvanceReceived    float64  `json:"advanceReceived"` // REAL type - no calculations in backend
	TotalReceived      float64  `json:"totalReceived"` // REAL type - no calculations in backend
	PartnerShareGiven  *float64 `json:"partnerShareGiven,omitempty"` // REAL type - no calculations in backend
